    ...
    <>
      ...
      >
        ...
        >
          <Link href={"/"}>
            <svg
              className="h-[1.5rem] md:h-[1.8rem] hidden dark:block"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 150 30"
              fill="#fff"
            >
              <path d="M45.1114 8.89822H47.9253V21.3612H45.1114V16.0739H40.3857V21.3612H37.5718V8.89822H40.3857V13.6637H45.1114V8.89822Z"></path>
          ...
          <Link href={"/"}>
            <svg
              className="h-[1.5rem] md:h-[1.8rem] block dark:hidden"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 150 30"
              fill={color ? "#000" : "#fff"}
            >
